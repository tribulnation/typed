...
class PremiumIndexPriceKline(RpcEndpoint):
  ...
  async def premium_index_price_kline_paged(
    ...
    *,
    ...
    Paged variant of `premium_index_price_kline`: Moves the `start`–`end` window backwards by its own width and stops on the first empty window, or after `max_pages` pages when one is given.
