...
import typed_dydx.protos.cosmos.gov.v1 as v1_proto
from typed_dydx.protos.cosmos.base.query.v1beta1 import PageRequest
from typed_dydx.protos.cosmos.gov.v1 import Proposal
from typed_dydx.protos.cosmos.gov.v1 import ProposalStatus
