...
from typed_dydx.core import TimestampIso, TimestampSeconds
...
class TimeResponse(TypedDict):
  ...
  """Indexer wall-clock time as fractional Unix seconds."""
  iso: TimestampIso
  """Indexer wall-clock time as an RFC 3339 timestamp."""
