...
class QueryOrder(RpcEndpoint):
  ...
  async def query_order(
    ...
    *,
    ...
    References:
      - [Official docs](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/trade#query-order)
    """
    params: dict = {
      'symbol': symbol,
    }
    ...
    _Response = FuturesOrder
    _validator = validator[_Response](_Response)
    return await self.authed_request(
      'GET', '/fapi/v1/order', params=params, validator=_validator, validate=validate
    )
