...
class OnChainYieldsLockedRewardsHistoryEntry(TypedDict):
  """One On-chain Yields locked product reward payment."""
...
class OnChainYieldsLockedRewardsHistoryPage(TypedDict):
  """One page of this account's On-chain Yields locked product rewards history."""

  rows: NotRequired[list[OnChainYieldsLockedRewardsHistoryEntry]]
...
class RewardsHistory(RpcEndpoint):
  """Get this account's On-chain Yields locked product rewards history."""
  ...
  async def rewards_history(
    ...
    *,
  ...
  ) -> OnChainYieldsLockedRewardsHistoryPage:
    """Get this account's On-chain Yields locked product rewards history.
    ...
    References:
      - [Official docs](https://developers.binance.com/en/docs/catalog/investment-and-services-staking/api/rest-api/on-chain-yields#get-on-chain-yields-locked-rewards-history)
    """
    params = {}
    ...
    if size is not None:
      params['size'] = size
    _Response = OnChainYieldsLockedRewardsHistoryPage
  ...
  async def rewards_history_paged(
    ...
    *,
    ...
    validate: bool | None = None,
  ) -> AsyncIterator[OnChainYieldsLockedRewardsHistoryPage]:
