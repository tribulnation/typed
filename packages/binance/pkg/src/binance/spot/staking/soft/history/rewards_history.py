...
class SoftStakingRewardsHistoryPage(TypedDict):
  ...
  rows: NotRequired[list[SoftStakingRewardsHistoryEntry]]
...
class RewardsHistory(RpcEndpoint):
  ...
  async def rewards_history(
    ...
    *,
    ...
    if size is not None:
      params['size'] = size
    _Response = SoftStakingRewardsHistoryPage
  ...
  async def rewards_history_paged(
    ...
    *,
    ...
    validate: bool | None = None,
  ) -> AsyncIterator[SoftStakingRewardsHistoryPage]:
