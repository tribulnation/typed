...
class StableLoanRepaymentHistoryEntry(TypedDict):
  ...
  """Collateral coin."""
  collateralUsed: NotRequired[str]
...
class StableLoanRepaymentHistoryPage(TypedDict):
  ...
  rows: NotRequired[list[StableLoanRepaymentHistoryEntry]]
...
class RepaymentHistory(RpcEndpoint):
  ...
  async def repayment_history(
    ...
    *,
    ...
    if limit is not None:
      params['limit'] = limit
    _Response = StableLoanRepaymentHistoryPage
  ...
  async def repayment_history_paged(
    ...
    *,
    ...
    validate: bool | None = None,
  ) -> AsyncIterator[StableLoanRepaymentHistoryPage]:
