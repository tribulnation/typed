...
class FlexibleLoanBorrowHistoryEntry(TypedDict):
  """One flexible loan borrow history entry."""
...
class FlexibleLoanBorrowHistoryPage(TypedDict):
  """One page of flexible loan borrow history."""

  rows: NotRequired[list[FlexibleLoanBorrowHistoryEntry]]
...
class BorrowHistory(RpcEndpoint):
  ...
  async def borrow_history(
    ...
    *,
    ...
    References:
      - [Official docs](https://developers.binance.com/en/docs/catalog/investment-and-services-crypto-loan/api/rest-api/flexible-rate#get-flexible-loan-borrow-history)
    """
    params = {}
    ...
    if limit is not None:
      params['limit'] = limit
    _Response = FlexibleLoanBorrowHistoryPage
  ...
  async def borrow_history_paged(
    ...
    *,
    ...
    validate: bool | None = None,
  ) -> AsyncIterator[FlexibleLoanBorrowHistoryPage]:
