...
class ListenKeyStop(WsRpcEndpoint):
  ...
  async def listen_key_stop(self, *, validate: bool | None = None) -> Responsereply:
    ...
    References:
      - [Official docs](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/user-data-streams#close-user-data-stream)
    """
