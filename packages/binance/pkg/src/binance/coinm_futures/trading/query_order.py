...
class CoinMQueryOrderResult(TypedDict):
  """The queried order."""
...
class QueryOrder(RpcEndpoint):
  ...
  async def query_order(
    ...
    *,
    ...
    References:
      - [Official docs](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/rest-api/trade#query-order)
    """
    params: dict = {
      'symbol': symbol,
    }
    ...
    _Response = CoinMQueryOrderResult
    _validator = validator[_Response](_Response)
    return await self.authed_request(
      'GET', '/dapi/v1/order', params=params, validator=_validator, validate=validate
    )
