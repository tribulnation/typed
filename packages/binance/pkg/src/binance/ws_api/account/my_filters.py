...
class MyFilters(WsRpcEndpoint):
  ...
  async def my_filters(
    ...
    References:
      - [Official docs](https://github.com/binance/binance-spot-api-docs/blob/master/web-socket-api.md#query-relevant-filters-user_data)
    """
    params: dict = {
      'symbol': symbol,
    }
    ...
    return await self.authed_request(
      'myFilters', params=params, validator=_validator, validate=validate
    )
