  ...
  async def order_list_place_oco(
    ...
    *,
    ...
    if above_peg_price_type is not None:
      params['abovePegPriceType'] = above_peg_price_type
    if above_peg_offset_type is not None:
      params['abovePegOffsetType'] = above_peg_offset_type
    if above_peg_offset_value is not None:
      params['abovePegOffsetValue'] = above_peg_offset_value
    ...
    if below_peg_price_type is not None:
      params['belowPegPriceType'] = below_peg_price_type
    if below_peg_offset_type is not None:
      params['belowPegOffsetType'] = below_peg_offset_type
    if below_peg_offset_value is not None:
      params['belowPegOffsetValue'] = below_peg_offset_value
    if new_order_resp_type is not None:
      params['newOrderRespType'] = new_order_resp_type
    if self_trade_prevention_mode is not None:
      params['selfTradePreventionMode'] = self_trade_prevention_mode
    _Response = OrderListOcoResult
    _validator = validator[_Response](_Response)
    return await self.authed_request(
      'orderList.place.oco', params=params, validator=_validator, validate=validate
    )
