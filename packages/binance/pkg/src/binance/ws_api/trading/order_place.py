...
class OrderPlace(WsRpcEndpoint):
  """Place new order"""
  ...
  async def order_place(
    ...
    *,
    ...
    References:
      - [Official docs](https://github.com/binance/binance-spot-api-docs/blob/master/web-socket-api.md#place-new-order-trade)
    """
    params: dict = {
      'symbol': symbol,
      'side': side,
