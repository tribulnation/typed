  ...
  async def ui_klines(
    ...
    *,
    ...
    Args:
      ...
      interval: Kline interval. See klines for the supported values.
    ...
    References:
      - [Official docs](https://github.com/binance/binance-spot-api-docs/blob/master/web-socket-api.md#ui-klines)
    """
    params: dict = {
      'symbol': symbol,
      'interval': interval,
    ...
    return await self.request(
      'uiKlines', params=params, validator=_validator, validate=validate
    )
