...
class TickerPrice(WsRpcEndpoint):
  ...
  async def ticker_price(
    ...
    *,
    ...
    """Get the latest market price for a symbol or symbols. If no symbol is specified, returns prices for all symbols currently trading on the exchange, as an array.
    ...
    References:
      - [Official docs](https://github.com/binance/binance-spot-api-docs/blob/master/web-socket-api.md#symbol-price-ticker)
    """
    params = {}
