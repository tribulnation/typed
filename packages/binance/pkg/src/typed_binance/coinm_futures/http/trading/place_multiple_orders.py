...
CoinMBatchNewOrderResults = list[CoinMBatchNewOrderSuccess | CoinMBatchOrderError]


class Request(TypedDict):
  """Request parameters."""

  batchOrders: list[CoinMBatchNewOrderParams]
  """Order list, max 5 orders. Sent as a JSON-array-valued query parameter, e.g. `batchOrders=[{...}]`."""
  ...
  async def place_multiple_orders(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=CoinMBatchNewOrderResults,
    )
