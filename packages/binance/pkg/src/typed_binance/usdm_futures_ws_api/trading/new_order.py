...
class NewOrder(WsRpcEndpoint):
  ...
  async def new_order(
    self,
    limit_order_market_order: LimitOrder | MarketOrder,
    *,
    ...
    Args:
      limit_order_market_order: New order request. Shape depends on order type; see docs/spec/authoring.md rule 0 -- a discriminated-union payload whose required fields differ by variant. Only LIMIT and MARKET are accepted here -- see notes.
    ...
    """
    params = dict(limit_order_market_order)
