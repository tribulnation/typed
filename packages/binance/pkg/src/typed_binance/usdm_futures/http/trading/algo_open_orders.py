...
class Request(TypedDict):
  ...
  """Filter by algo order family."""
  symbol: NotRequired[str]
  """Trading symbol. If omitted, orders for every symbol are returned."""
  algoId: NotRequired[int]
  """Filter by a specific algo order ID."""


FuturesOpenAlgoOrders = list[FuturesOpenAlgoOrder]
  ...
  async def algo_open_orders(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=FuturesOpenAlgoOrders,
    )
