...
class FuturesPositionRiskV3Row(TypedDict):
  ...
  """Entry price."""
  breakEvenPrice: NotRequired[Decimal]
  """Break-even price."""
  ...
  initialMargin: NotRequired[Decimal]
  """Initial margin required at current mark price."""
  maintMargin: NotRequired[Decimal]
  """Maintenance margin required."""
  positionInitialMargin: NotRequired[Decimal]
  """Initial margin required for positions at current mark price."""
  openOrderInitialMargin: NotRequired[Decimal]
