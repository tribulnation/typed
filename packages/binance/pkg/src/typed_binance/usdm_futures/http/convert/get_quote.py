...
class Request(TypedDict):
  ...
  """Amount debited after the conversion. Either this or `toAmount` should be sent."""
  toAmount: NotRequired[float]
  """Amount credited after the conversion. Either this or `fromAmount` should be sent."""
  ...
  async def get_quote(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=UsdMFuturesConvertQuote,
    )
