...
class Request(TypedDict):
  ...
  withdrawOrderId: NotRequired[str]
  """Client-side id for the withdrawal, if one was provided in spot.wallet.capital.withdraw.apply or spot.wallet.local_entity.withdraw.apply."""
  network: NotRequired[str]
...
Response = list[LocalEntityWithdrawal]
