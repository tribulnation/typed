...
class Request(TypedDict):
  ...
  """Comma-separated list of travel rule record ids to filter by. Maximum 45 ids."""
  txId: NotRequired[str]
  """Comma-separated list of transaction ids to filter by. Maximum 45 ids."""
  withdrawOrderId: NotRequired[str]
  """Client-side id for the withdrawal, if one was provided in spot.wallet.capital.withdraw.apply or spot.wallet.local_entity.withdraw.apply. Only a single id is supported. If sent, startTime/endTime must span under 7 days; if startTime/endTime are also omitted, the last 7 days are returned by default."""
  network: NotRequired[str]
  ...
  """Start of the query window, as milliseconds since epoch. Defaults to 90 days before the current time (7 days if withdrawOrderId is sent)."""
  endTime: NotRequired[TimestampMillis]
  """End of the query window, as milliseconds since epoch. Defaults to the current time."""


Response = list[LocalEntityWithdrawalV2]
