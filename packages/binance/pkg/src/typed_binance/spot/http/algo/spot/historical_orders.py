...
class HistoricalOrders(RpcEndpoint):
  ...
  def historical_orders_paged(
    ...
    *,
  ...
  ) -> PaginatedResponse[SpotAlgoHistoricalOrder, int]:
    """Get historical (finished or cancelled) spot TWAP orders.
    ...
    async def next(page: int) -> tuple[Sequence[SpotAlgoHistoricalOrder], int | None]:
  ...
  async def historical_orders(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=SpotAlgoHistoricalOrders,
    )
