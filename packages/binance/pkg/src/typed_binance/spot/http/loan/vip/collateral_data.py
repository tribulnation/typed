...
class VipLoanCollateralAsset(TypedDict):
  ...
  """Collateral ratio applied to the first value tier, as a percentage string with a literal `%` suffix (e.g. `"90%"`)."""
  _1stCollateralRange: str
  """Value range of the first collateral tier."""
  _2ndCollateralRatio: str
  """Collateral ratio applied to the second value tier, as a percentage string with a literal `%` suffix (e.g. `"90%"`)."""
  _2ndCollateralRange: str
  """Value range of the second collateral tier."""
  _3rdCollateralRatio: str
  """Collateral ratio applied to the third value tier, as a percentage string with a literal `%` suffix (e.g. `"90%"`)."""
  _3rdCollateralRange: str
  """Value range of the third collateral tier."""
  _4thCollateralRatio: str
  """Collateral ratio applied to the fourth value tier, as a percentage string with a literal `%` suffix (e.g. `"90%"`)."""
