...
class Request(TypedDict):
  ...
  """Millisecond epoch upper bound. Maximum interval between `startTime` and `endTime` is 90 days. Time is based on UTC+0."""
...
class FlexibleLoanInterestRateHistoryPage(TypedDict):
  ...
  rows: list[FlexibleLoanInterestRateHistoryEntry]
...
class InterestRateHistory(RpcEndpoint):
  ...
  def interest_rate_history_paged(
    ...
    *,
  ...
  ) -> PaginatedResponse[FlexibleLoanInterestRateHistoryEntry, int]:
    """Check Flexible Loan interest rate history.
    ...
    async def next(
      current: int,
    ) -> tuple[Sequence[FlexibleLoanInterestRateHistoryEntry], int | None]:
  ...
  async def interest_rate_history(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=FlexibleLoanInterestRateHistoryPage,
    )
