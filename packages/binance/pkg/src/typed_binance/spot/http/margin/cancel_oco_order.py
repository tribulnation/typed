...
class Request(TypedDict):
  ...
  """Id of the order list to cancel. Either orderListId or listClientOrderId must be provided."""
  listClientOrderId: NotRequired[str]
  """Client id of the order list to cancel. Either orderListId or listClientOrderId must be provided."""
  ...
  async def cancel_oco_order(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=MarginCancelOcoOrderResult,
    )
