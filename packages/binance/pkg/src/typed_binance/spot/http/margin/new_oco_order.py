...
class Request(TypedDict):
  ...
  """Iceberg quantity for the limit order leg."""
  ...
  """Limit price of the stop order leg, making it STOP_LOSS_LIMIT instead of STOP_LOSS. If provided, stopLimitTimeInForce is required."""
  stopIcebergQty: NotRequired[float]
  """Iceberg quantity for the stop order leg. Usable only when stopLimitPrice is provided."""
  stopLimitTimeInForce: NotRequired[Literal['GTC', 'FOK', 'IOC']]
  """Time in force for the stop-loss-limit leg. Required when stopLimitPrice is provided."""
  ...
  """Margin borrow/repay side effect of this order list. Defaults to NO_SIDE_EFFECT."""
  ...
  async def new_oco_order(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=MarginNewOcoOrderResult,
    )
