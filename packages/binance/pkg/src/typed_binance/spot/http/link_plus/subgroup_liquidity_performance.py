...
class Request(TypedDict):
  ...
  """Query on a specific date, as milliseconds since epoch. Defaults to the latest data on Today - 1."""
  ...
  async def subgroup_liquidity_performance(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/sapi/v1/vip/liquidity-programs/subgroups/performance',
      meta={'security': 'USER_DATA', 'signed': True},
      validate=validate,
      request_type=Request,
      response_type=SubGroupLiquidityProgramPerformance,
    )
