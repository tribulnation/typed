...
class Request(TypedDict):
  ...
  """Query a specific week, as milliseconds since epoch. Defaults to the latest data on the previous week."""
  ...
  async def subgroup_liquidity_weekly_result(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/sapi/v1/vip/liquidity-programs/subgroups/weekly-result',
      meta={'security': 'USER_DATA', 'signed': True},
      validate=validate,
      request_type=Request,
      response_type=SubGroupLiquidityProgramWeeklyResult,
    )
