...
Response = BrokerSubAccountFuturesSummaryV2Usdm | BrokerSubAccountFuturesSummaryV2Coinm
...
class SubAccountFuturesSummaryV2(RpcEndpoint):
  ...
  def sub_account_futures_summary_v2_paged(
    self,
    ...
    *,
    ...
    BrokerSubAccountUsdmFuturesAsset | BrokerSubAccountCoinmFuturesAsset, int
  ]:
    """Get futures asset totals across sub-accounts for one futures product. `futuresType`: `1` = USDⓈ-M Futures, `2` = COIN-M Futures — the response shape differs by which was requested.

    Paged variant of `sub_account_futures_summary_v2`: Requests `page` from 1 upwards and stops on the first page shorter than `size`. Awaitable (flattens every page) or async-iterable (one page at a time).
    ...
    async def next(
      ...
      Sequence[BrokerSubAccountUsdmFuturesAsset | BrokerSubAccountCoinmFuturesAsset],
      int | None,
    ]:
  ...
  async def sub_account_futures_summary_v2(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/sapi/v2/broker/subAccount/futuresSummary',
