...
class SubAccountFuturesSummaryV2(RpcEndpoint):
  ...
  async def sub_account_futures_summary_v2_paged(
    ...
    *,
    ...
    Paged variant of `sub_account_futures_summary_v2`: Requests `page` from 1 upwards and stops on the first page shorter than `size`, or after `max_pages` pages when one is given.
