...
class SorOrderTest(RpcEndpoint):
  ...
  async def sor_order_test(
    ...
    *,
    ...
    Args:
      sor_limit_order_sor_market_order: New SOR order request to validate. Shape depends on order type (LIMIT or MARKET); see docs/spec/authoring.md rule 0 -- a discriminated-union payload whose required fields differ by variant.
