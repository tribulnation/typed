...
class WbethRewardsHistory(RpcEndpoint):
  ...
  def wbeth_rewards_history_paged(
    ...
    *,
    ...
    Paged variant of `wbeth_rewards_history`: Awaitable (flattens every page) or async-iterable (one page at a time).
    ...
    async def next(current: int) -> tuple[list[WbethReward], int | None]:
