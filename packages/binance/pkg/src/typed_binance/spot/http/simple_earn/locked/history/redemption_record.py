...
class LockedRedemptionRecordPage(TypedDict):
  ...
  rows: list[LockedRedemptionRecord]
...
class RedemptionRecord(RpcEndpoint):
  ...
  def redemption_record_paged(
    ...
    *,
  ...
  ) -> PaginatedResponse[LockedRedemptionRecord, int]:
    """Get this account's Simple Earn locked product redemption history.
    ...
    async def next(current: int) -> tuple[Sequence[LockedRedemptionRecord], int | None]:
  ...
  async def redemption_record(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=LockedRedemptionRecordPage,
    )
