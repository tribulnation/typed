...
class Request(TypedDict):
  ...
  dt: NotRequired[int]
  """Millisecond epoch date to query a specific day's statistics for. Defaults to the latest available data, i.e. yesterday."""
  ...
  async def liquidity_program_performance(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/sapi/v1/vip/liquidity-programs/performance',
      meta={'security': 'USER_DATA', 'signed': True},
      validate=validate,
      request_type=Request,
      response_type=LiquidityProgramPerformanceResult,
    )
