...
class Request(TypedDict):
  ...
  dt: NotRequired[int]
  """Millisecond epoch date to query a specific week for. Defaults to the latest completed week's results."""
  ...
  async def liquidity_program_weekly_result(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/sapi/v1/vip/liquidity-programs/weekly-result',
      meta={'security': 'USER_DATA', 'signed': True},
      validate=validate,
      request_type=Request,
      response_type=LiquidityProgramWeeklyResultsResult,
    )
