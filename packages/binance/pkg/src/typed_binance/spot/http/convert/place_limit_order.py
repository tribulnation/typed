...
class Request(TypedDict):
  ...
  baseAsset: str
  """Base asset of the conversion pair."""
  quoteAsset: str
  """Quote asset of the conversion pair."""
  limitPrice: float
  """Target price, in `quoteAsset` per `baseAsset`, that triggers the conversion."""
  side: Literal['BUY', 'SELL']
  """Order side, relative to `baseAsset`."""
  expiredType: Literal['1_D', '3_D', '7_D', '30_D']
  """How long the order stays open before expiring."""
  baseAmount: NotRequired[float]
  """Amount of `baseAsset` to convert. Either this or `quoteAmount` is required."""
  quoteAmount: NotRequired[float]
  """Amount of `quoteAsset` to convert. Either this or `baseAmount` is required."""
  ...
  async def place_limit_order(
    ...
    *,
    ...
    if quote_amount is not None:
      request['quoteAmount'] = quote_amount
    ...
    return await self.request(
      ...
      response_type=ConvertLimitOrderPlaced,
    )
