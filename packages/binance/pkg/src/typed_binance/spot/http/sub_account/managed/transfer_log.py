...
class TransferLog(RpcEndpoint):
  ...
  def transfer_log_paged(
    ...
    *,
    ...
    Paged variant of `transfer_log`: Requests `page` from 1 upwards and stops once it has covered the `count` items the response reports, or on an empty page. Awaitable (flattens every page) or async-iterable (one page at a time).
