...
class Request(TypedDict):
  ...
  """Id of the order list to cancel. Either orderListId or listClientOrderId must be sent."""
  listClientOrderId: NotRequired[str]
  """Client id of the order list to cancel. Either orderListId or listClientOrderId must be sent."""
  ...
  async def order_list_cancel(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=OrderListCancelResult,
    )
