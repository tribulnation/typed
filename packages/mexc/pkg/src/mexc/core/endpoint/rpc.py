"""Base endpoint class for RPC (request/reply) endpoints."""
...
class RpcEndpoint:
  """Base class for RPC endpoints. A subsection composing children exposes each as a
  `functools.cached_property` returning `Child(client=self.client)`.
  """
