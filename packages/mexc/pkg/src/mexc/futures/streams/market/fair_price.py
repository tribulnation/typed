...
class FairPriceStream(StreamsMixin):
  def fair_price(self, symbol: str, *, validate: bool = True) -> StreamManager[FairPrice, Reply, Reply]:
    """
  ...
  async def _fair_price_impl(self, symbol: str, *, validate: bool = True) -> Stream[FairPrice, Reply, Reply]:
