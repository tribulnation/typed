...
from typed_mexc.core import timestamp_millis as ts, AuthError, ValidationMixin
from typed_mexc.core.auth import resolve_credentials
from typed_mexc.futures.core import sign
...
class AuthedStreamsClient(Streams[Any, Any, None, None]):
  ...
  def new(
    ...
    return cls(api_key=creds.api_key, api_secret=creds.api_secret, url=url)
