...
Request = IsolatedMarginOrder | CrossMarginOrder


class SubmitOrder(FuturesHttpEndpoint):
  ...
  async def submit_order(
    ...
    *,
    ...
    References:
      - [Official docs](https://www.mexc.com/api-docs/futures/account-and-trading-endpoints/place-order)
    """
    return await self.request(
      ...
      response_type=SubmitOrderResponse,
    )
