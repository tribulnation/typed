...
Response: type[AffiliateSubaffiliatesResponse | ErrorResponse] = (
  AffiliateSubaffiliatesResponse | ErrorResponse
)  # type: ignore
  ...
  async def affiliate_subaffiliates(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/rebate/affiliate/subaffiliates', params=params
    )
