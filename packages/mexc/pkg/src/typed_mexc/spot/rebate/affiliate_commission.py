...
from typed_mexc.core import (
  TimestampMillis,
  TimestampSeconds,
  timestamp_millis as ts,
  validator,
)
...
Response: type[AffiliateCommissionResponse | ErrorResponse] = (
  AffiliateCommissionResponse | ErrorResponse
)  # type: ignore
  ...
  async def affiliate_commission(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/rebate/affiliate/commission', params=params
    )
