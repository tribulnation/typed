...
Response: type[AffiliateCommissionDetailResponse | ErrorResponse] = (
  AffiliateCommissionDetailResponse | ErrorResponse
)  # type: ignore
  ...
  async def affiliate_commission_detail(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/rebate/affiliate/commission/detail', params=params
    )
