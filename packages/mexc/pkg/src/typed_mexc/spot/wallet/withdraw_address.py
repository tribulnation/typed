...
Response: type[WithdrawAddressResponse | ErrorResponse] = (
  WithdrawAddressResponse | ErrorResponse
)  # type: ignore
  ...
  async def withdraw_address(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/capital/withdraw/address', params=params
    )
    ...
    *,
    ...
    while True:
      response = await self.withdraw_address(
        coin=coin, limit=limit, timestamp=timestamp, page=page, validate=validate
      )
      yield response
      pages += 1
