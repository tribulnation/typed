...
Response: type[UniversalTransferByTranIdResponse | ErrorResponse] = (
  UniversalTransferByTranIdResponse | ErrorResponse
)  # type: ignore
  ...
  async def universal_transfer_by_tran_id(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/capital/transfer/tranId', params=params
    )
