...
Response: type[InternalTransferHistoryResponse | ErrorResponse] = (
  InternalTransferHistoryResponse | ErrorResponse
)  # type: ignore
  ...
  async def internal_transfer_history(
    ...
    *,
    ...
    r = await self.signed_request(
      'GET', '/api/v3/capital/transfer/internal', params=params
    )
