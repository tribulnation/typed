...
section), composed as peers. `.new()` is the only place credentials get resolved —
every surface just receives an already-resolved `Credentials | None`.
"""
