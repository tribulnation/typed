...
class Entry(TypedDict):
  ...
  """Opening price (price 24 horus ago); null when unavailable for this market."""
  ...
  percentage: NotRequired[float | None]
  """Percentage of current price versus opening price; null when unavailable for this market."""
