"""`GET /api/v3/hf/margin/stop-order/orderId` — Get Stop Order By OrderId."""
...
class GetByOrderId(RpcEndpoint):
  """`Get Stop Order By OrderId` — mixed into `StopOrders`, the product exposing `margin.stop_orders.get_by_order_id`."""
  ...
  async def get_by_order_id(
    ...
    *,
    ...
    """Get a single margin stop order's full detail by its system-generated order id, or `null` when no such order exists for this account.

    Args:
      order_id: System-generated id of the stop order to look up.
