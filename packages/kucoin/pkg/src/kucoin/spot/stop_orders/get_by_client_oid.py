"""`GET /api/v1/stop-order/queryOrderByClientOid` — spot.stop_orders.get_by_client_oid."""
...
_Type = list[StopOrder]
adapter = validator[_Type](_Type)  # type: ignore


class GetByClientOid(RpcEndpoint):
  """`spot.stop_orders.get_by_client_oid` — mixed into `StopOrders`, the product exposing `spot.stop_orders.get_by_client_oid`."""
