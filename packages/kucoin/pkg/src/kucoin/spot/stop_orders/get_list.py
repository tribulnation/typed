"""`GET /api/v1/stop-order` — spot.stop_orders.get_list."""
...
_Type = StopOrdersPage
adapter = validator[_Type](_Type)  # type: ignore


class GetList(RpcEndpoint):
  """`spot.stop_orders.get_list` — mixed into `StopOrders`, the product exposing `spot.stop_orders.get_list`."""
