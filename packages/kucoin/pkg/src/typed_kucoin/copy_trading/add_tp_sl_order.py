...
from typed_kucoin.schemas import CopyTradeAddOrderResult
...
Request = CopyTradeAddTpSlOrderLimit | CopyTradeAddTpSlOrderMarket
...
class AddTpSlOrder(RpcEndpoint):
  ...
  async def add_tp_sl_order(
    ...
    *,
    ...
    References:
      - [Official docs](https://www.kucoin.com/docs-new/rest/copy-trading/add-take-profit-and-stop-loss-order)
    """
