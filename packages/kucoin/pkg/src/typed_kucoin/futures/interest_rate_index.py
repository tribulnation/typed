...
class InterestRateIndex(RpcEndpoint):
  ...
  async def interest_rate_index_paged(
    ...
    *,
    ...
    Paged variant of `interest_rate_index`: Moves the `start_at`–`end_at` window forwards by its own width and stops on the first empty window, or after `max_pages` pages when one is given.
