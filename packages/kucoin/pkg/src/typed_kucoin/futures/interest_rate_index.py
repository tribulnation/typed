...
class InterestRateIndex(RpcEndpoint):
  ...
  def interest_rate_index_paged(
    ...
    *,
    ...
    References:
      - [Official docs](https://www.kucoin.com/docs-new/rest/futures-trading/market-data/get-interest-rate-index)
    """
  ...
  async def interest_rate_index(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/api/v1/interest/query',
      meta={},
      validate=validate,
      request_type=Request,
      response_type=FuturesInterestRateSnapshotPage,
    )
