...
class GetStopOrderList(RpcEndpoint):
  ...
  def get_stop_order_list_paged(
    ...
    *,
    ...
    Paged variant of `get_stop_order_list`: Requests `currentPage` from 1 upwards and stops once it has covered the `totalPage` pages the response reports, or on an empty page. Awaitable (flattens every page) or async-iterable (one page at a time).
