...
class GetByClientOid(RpcEndpoint):
  ...
  async def get_by_client_oid(
    ...
    *,
    ...
    References:
      - [Official docs](https://www.kucoin.com/docs-new/rest/margin-trading/orders/get-stop-order-by-clientoid)
    """
    return await self.request(
      Request(clientOid=client_oid),
      method='GET',
      path='/api/v3/hf/margin/stop-order/clientOid',
      meta={'signed': True},
      validate=validate,
