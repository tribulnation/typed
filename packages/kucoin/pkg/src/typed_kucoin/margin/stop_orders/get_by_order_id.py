...
class Request(TypedDict):
  orderId: str
  """System-generated id of the stop order to look up."""
...
class GetByOrderId(RpcEndpoint):
  ...
  async def get_by_order_id(
    ...
    References:
      - [Official docs](https://www.kucoin.com/docs-new/rest/margin-trading/orders/get-stop-order-by-orderld)
    """
    return await self.request(
      Request(orderId=order_id),
      method='GET',
      path='/api/v3/hf/margin/stop-order/orderId',
      meta={'signed': True},
      validate=validate,
