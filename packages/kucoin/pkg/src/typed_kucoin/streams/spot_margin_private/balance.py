...
class BalanceUpdate(TypedDict):
  ...
  TimestampMillis`), which is a real JSON integer."""
...
class Balance(PrivateStreamEndpoint):
  """Subscribe to `/account/balance` — mixed into `SpotMarginPrivate`, the product
  exposing `streams.spot_margin_private.balance`."""
