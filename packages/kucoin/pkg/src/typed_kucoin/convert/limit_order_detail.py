...
Response = ConvertLimitOrder | None
...
class LimitOrderDetail(RpcEndpoint):
  ...
  async def limit_order_detail(
    ...
    *,
    ...
    References:
      - [Official docs](https://www.kucoin.com/docs-new/rest/convert/get-convert-limit-order-detail)
    """
    ...
    return await self.request(
      request,
      method='GET',
      path='/api/v1/convert/limit/order/detail',
      meta={'signed': True},
      validate=validate,
