...
validate_get_last_trades_by_currency_and_time = validator[TradesPage](TradesPage)
...
class GetLastTradesByCurrencyAndTime(RpcEndpoint):
  ...
  async def get_last_trades_by_currency_and_time(
    ...
    **Scope:** `trade:read`
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/market-data/public-get_last_trades_by_currency_and_time)
    """
    params: dict = {
      'currency': currency,
    ...
    return await self.request(
      'public/get_last_trades_by_currency_and_time',
      params=params,
      validator=validate_get_last_trades_by_currency_and_time,
      validate=validate,
    )
