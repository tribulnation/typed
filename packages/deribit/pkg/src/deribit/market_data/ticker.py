...
class TickerEndpoint(RpcEndpoint):
  ...
  async def ticker(
    self, *, instrument_name: str, validate: bool | None = None
  ) -> Ticker:
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/market-data/public-ticker)
    """
    params: dict = {
      'instrument_name': instrument_name,
    }
    return await self.request(
      'public/ticker', params=params, validator=validate_ticker, validate=validate
    )
