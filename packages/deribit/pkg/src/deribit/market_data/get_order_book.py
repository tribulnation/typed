...
validate_get_order_book = validator[OrderBookSnapshot](OrderBookSnapshot)
...
class GetOrderBook(RpcEndpoint):
  ...
  async def get_order_book(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/market-data/public-get_order_book)
    """
    params: dict = {
    ...
    return await self.request(
      'public/get_order_book',
      params=params,
      validator=validate_get_order_book,
      validate=validate,
    )
