...
validate_get_last_trades_by_instrument_and_time = validator[TradesPage](TradesPage)
...
class GetLastTradesByInstrumentAndTime(RpcEndpoint):
  ...
  async def get_last_trades_by_instrument_and_time(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/market-data/public-get_last_trades_by_instrument_and_time)
    """
    params: dict = {
    ...
    return await self.request(
      'public/get_last_trades_by_instrument_and_time',
      params=params,
      validator=validate_get_last_trades_by_instrument_and_time,
      validate=validate,
    )
