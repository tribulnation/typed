...
validate_get_order_history_by_currency = validator[list[Order]](list[Order])
...
class GetOrderHistoryByCurrency(RpcEndpoint):
  ...
  async def get_order_history_by_currency(
    ...
    **📖 Related Article:** [Accessing Historical Trades and Orders Using API](https://docs.deribit.com/articles/accessing-historical-trades-orders)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_order_history_by_currency)
    """
    params: dict = {
      'currency': currency,
    }
    ...
    return await self.authed_request(
      'private/get_order_history_by_currency',
      params=params,
      validator=validate_get_order_history_by_currency,
      validate=validate,
    )
