...
validate_get_open_orders_by_instrument = validator[list[Order]](list[Order])
...
class GetOpenOrdersByInstrument(RpcEndpoint):
  ...
  async def get_open_orders_by_instrument(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_open_orders_by_instrument)
    """
    params: dict = {
    ...
    return await self.authed_request(
      'private/get_open_orders_by_instrument',
      params=params,
      validator=validate_get_open_orders_by_instrument,
      validate=validate,
    )
