...
class GetUserTradesByInstrumentResult(TypedDict):
...
validate_get_user_trades_by_instrument = validator[GetUserTradesByInstrumentResult](
...
class GetUserTradesByInstrument(RpcEndpoint):
  ...
  async def get_user_trades_by_instrument(
    ...
    **📖 Related Article:** [Accessing Historical Trades and Orders Using API](https://docs.deribit.com/articles/accessing-historical-trades-orders)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_user_trades_by_instrument)
    """
    params: dict = {
    ...
    return await self.authed_request(
      'private/get_user_trades_by_instrument',
      params=params,
      validator=validate_get_user_trades_by_instrument,
      validate=validate,
    )
