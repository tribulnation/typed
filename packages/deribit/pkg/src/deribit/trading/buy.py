...
class BuyLimitOrder(TypedDict):
  """LimitOrder order parameters for `private/buy`."""
...
class BuyMarketOrder(TypedDict):
  """MarketOrder order parameters for `private/buy`."""
...
class BuyStopLimitOrder(TypedDict):
  """StopLimitOrder order parameters for `private/buy`."""
...
class BuyStopMarketOrder(TypedDict):
  """StopMarketOrder order parameters for `private/buy`."""
...
class BuyTrailingStopOrder(TypedDict):
  """TrailingStopOrder order parameters for `private/buy`."""
...
validate_buy = validator[BuyResult](BuyResult)
...
class Buy(RpcEndpoint):
  ...
  async def buy(
    self,
    buy_order_params: BuyLimitOrder
    | BuyMarketOrder
    | BuyStopLimitOrder
    | BuyStopMarketOrder
    | BuyTrailingStopOrder,
    *,
    ...
    Args:
      buy_order_params: Order parameters for `private/buy`, keyed by JSON-RPC param name.
      validate: Validate the response against the generated schema.

    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-buy)
    """
    return await self.authed_request(
      'private/buy', params=buy_order_params, validator=validate_buy, validate=validate
    )
