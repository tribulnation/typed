...
validate_cancel_all_by_kind_or_type = validator[float | list[CancelGroup]](float | list[CancelGroup])  # pyright: ignore[reportArgumentType]  # fmt: skip
...
class CancelAllByKindOrType(RpcEndpoint):
  ...
  async def cancel_all_by_kind_or_type(
    ...
    **📖 Related Article:** [Detailed Response for Cancel Methods](https://docs.deribit.com/articles/json-rpc-overview#detailed-response-for-cancel-methods)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-cancel_all_by_kind_or_type)
    """
    params: dict = {
      'currency': currency,
    }
    ...
    return await self.authed_request(
      'private/cancel_all_by_kind_or_type',
      params=params,
      validator=validate_cancel_all_by_kind_or_type,
      validate=validate,
    )
