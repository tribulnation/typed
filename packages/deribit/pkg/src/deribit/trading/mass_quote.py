...
validate_mass_quote = validator[MassQuoteResult](MassQuoteResult)
...
class MassQuote(RpcEndpoint):
  ...
  async def mass_quote(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-mass_quote)
    """
    params: dict = {
      'quote_id': quote_id,
      'mmp_group': mmp_group,
    ...
    if wait_for_response is not None:
      params['wait_for_response'] = wait_for_response
