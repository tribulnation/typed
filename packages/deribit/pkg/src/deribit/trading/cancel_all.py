...
validate_cancel_all = validator[float | list[CancelGroup]](float | list[CancelGroup])  # pyright: ignore[reportArgumentType]  # fmt: skip
...
class CancelAll(RpcEndpoint):
  ...
  async def cancel_all(
    ...
    **📖 Related Article:** [Detailed Response for Cancel Methods](https://docs.deribit.com/articles/json-rpc-overview#detailed-response-for-cancel-methods)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-cancel_all)
    """
    params = {}
