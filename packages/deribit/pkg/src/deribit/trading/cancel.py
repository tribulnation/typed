...
validate_cancel = validator[Order](Order)


class Cancel(RpcEndpoint):
  """`private/cancel`."""

  async def cancel(self, *, order_id: str, validate: bool | None = None) -> Order:
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-cancel)
    """
    params: dict = {
      'order_id': order_id,
    }
    return await self.authed_request(
      'private/cancel', params=params, validator=validate_cancel, validate=validate
    )
