...
validate_get_open_orders = validator[list[Order]](list[Order])
...
class GetOpenOrders(RpcEndpoint):
  ...
  async def get_open_orders(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_open_orders)
    """
    params = {}
    if kind is not None:
      params['kind'] = kind
    ...
    return await self.authed_request(
      'private/get_open_orders',
      params=params,
      validator=validate_get_open_orders,
      validate=validate,
    )
