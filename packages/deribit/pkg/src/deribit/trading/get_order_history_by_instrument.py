...
validate_get_order_history_by_instrument = validator[list[Order]](list[Order])


class GetOrderHistoryByInstrument(RpcEndpoint):
  ...
  async def get_order_history_by_instrument(
    ...
    **📖 Related Article:** [Accessing Historical Trades and Orders Using API](https://docs.deribit.com/articles/accessing-historical-trades-orders)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_order_history_by_instrument)
    """
    params: dict = {
    ...
    if include_unfilled is not None:
      params['include_unfilled'] = include_unfilled
    if with_continuation is not None:
      params['with_continuation'] = with_continuation
    ...
    return await self.authed_request(
      'private/get_order_history_by_instrument',
      params=params,
      validator=validate_get_order_history_by_instrument,
      validate=validate,
    )
