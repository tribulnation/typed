...
validate_cancel_quotes = validator[float | list[CancelGroup]](float | list[CancelGroup])  # pyright: ignore[reportArgumentType]  # fmt: skip
...
class CancelQuotes(RpcEndpoint):
  ...
  async def cancel_quotes(
    ...
    **📖 Related Article:** [Detailed Response for Cancel Methods](https://docs.deribit.com/articles/json-rpc-overview#detailed-response-for-cancel-methods)
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-cancel_quotes)
    """
    params: dict = {
    ...
    if quote_set_id is not None:
      params['quote_set_id'] = quote_set_id
    ...
    return await self.authed_request(
      'private/cancel_quotes',
      params=params,
      validator=validate_cancel_quotes,
      validate=validate,
    )
