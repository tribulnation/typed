...
validate_get_open_orders_by_label = validator[list[Order]](list[Order])
...
class GetOpenOrdersByLabel(RpcEndpoint):
  ...
  async def get_open_orders_by_label(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-get_open_orders_by_label)
    """
    params: dict = {
      'currency': currency,
      'label': label,
    ...
    return await self.authed_request(
      'private/get_open_orders_by_label',
      params=params,
      validator=validate_get_open_orders_by_label,
      validate=validate,
    )
