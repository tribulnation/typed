...
validate_close_position = validator[ClosePositionResult](ClosePositionResult)
  ...
  async def close_position(
    ...
    *,
    ...
    Args:
      ...
      type: The order type
      price: Optional price for limit order.
      validate: Validate the response against the generated schema.

    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-close_position)
    """
    params: dict = {
    ...
    return await self.authed_request(
      'private/close_position',
      params=params,
      validator=validate_close_position,
      validate=validate,
    )
