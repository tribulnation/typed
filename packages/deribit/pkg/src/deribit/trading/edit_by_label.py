...
class EditByLabelResult(TypedDict):
  order: Order
  trades: list[UserTrade]
  """Trades generated immediately by this call (empty if nothing filled yet)."""


validate_edit_by_label = validator[EditByLabelResult](EditByLabelResult)
...
class EditByLabel(RpcEndpoint):
  ...
  async def edit_by_label(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/trading/private-edit_by_label)
    """
    params: dict = {
    ...
    return await self.authed_request(
      'private/edit_by_label',
      params=params,
      validator=validate_edit_by_label,
      validate=validate,
    )
