"""`trades.{instrument_name}.{interval}` — subscription."""
...
validate_trades_by_instrument = validator[list[TradeUpdate]](list[TradeUpdate])
...
class TradesByInstrument(StreamEndpoint):
  ...
  def trades_by_instrument(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/subscriptions/trades/tradesinstrument_nameinterval)
    """
