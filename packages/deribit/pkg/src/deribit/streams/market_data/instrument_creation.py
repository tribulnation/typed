"""`instrument.creation.{kind}.{currency}` — subscription."""
...
validate_instrument_creation = validator[Instrument](Instrument)
...
class InstrumentCreation(StreamEndpoint):
  ...
  def instrument_creation(
    ...
    *,
  ...
  ) -> StreamManager[Instrument, Any, Any]:
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/subscriptions/market-data/instrumentcreationkindcurrency)
    """
    channel = f'instrument.creation.{kind}.{currency}'
    return self.subscribe(
      channel, validator=validate_instrument_creation, validate=validate
    )
