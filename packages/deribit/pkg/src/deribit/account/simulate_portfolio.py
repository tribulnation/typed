...
validate_simulate_portfolio = validator[SimulatePortfolioResult](
  ...
  async def simulate_portfolio(
    ...
    *,
    ...
    Args:
      ...
      simulated_positions: A JSON-encoded object of `{instrumentName: size, ...}`, e.g. `{"BTC-PERPETUAL": -1.0}` (URI-encoded for a GET request). Size is in base currency for futures, base currency coin for options.
      validate: Validate the response against the generated schema.

    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/account-management/private-simulate_portfolio)
    """
    params: dict = {
      'currency': currency,
    }
    ...
    return await self.authed_request(
      'private/simulate_portfolio',
      params=params,
      validator=validate_simulate_portfolio,
      validate=validate,
    )
