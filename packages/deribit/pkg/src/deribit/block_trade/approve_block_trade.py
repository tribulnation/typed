...
validate_approve_block_trade = validator[Literal['ok']](Literal['ok'])  # pyright: ignore[reportArgumentType]  # fmt: skip
...
class ApproveBlockTrade(RpcEndpoint):
  ...
  async def approve_block_trade(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/block-trade/private-approve_block_trade)
    """
    params: dict = {
      'timestamp': timestamp,
      'nonce': nonce,
    ...
    return await self.authed_request(
      'private/approve_block_trade',
      params=params,
      validator=validate_approve_block_trade,
      validate=validate,
    )
