...
class BlockTradeItem(TypedDict):
...
validate_get_block_trades = validator[list[BlockTradeItem]](list[BlockTradeItem])
...
class GetBlockTrades(RpcEndpoint):
  ...
  async def get_block_trades(
    ...
    *,
    ...
    References:
      - [Deribit API docs](https://docs.deribit.com/api-reference/block-trade/private-get_block_trades)
    """
    params = {}
    ...
    return await self.authed_request(
      'private/get_block_trades',
      params=params,
      validator=validate_get_block_trades,
      validate=validate,
    )
