...
class ClosePosition(RpcEndpoint):
  ...
  async def close_position(
    self,
    close_position_order_params: ClosePositionLimitOrder | ClosePositionMarketOrder,
    *,
    ...
    Args:
      close_position_order_params: Order parameters for `private/close_position`, keyed by JSON-RPC param name.
    ...
    return await self.authed_request(
      'private/close_position',
      params=close_position_order_params,
