...
class PriceStatistics(StreamEndpoint):
  ...
  def price_statistics(
    ...
    *,
    ...
    References:
      - [Official docs](https://docs.deribit.com/subscriptions/market-data/deribit_price_statisticsindex_name)
    """
    return self.subscribe(
      f'deribit_price_statistics.{index_name}',
      meta={'public': True},
      validate=validate,
      response_type=PriceStatisticsUpdate,
    )
