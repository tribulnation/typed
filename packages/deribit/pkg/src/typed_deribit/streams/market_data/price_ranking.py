...
PriceRankingUpdate = list[PriceRankingEntry]
...
class PriceRanking(StreamEndpoint):
  ...
  def price_ranking(
    ...
    *,
  ...
  ) -> StreamManager[PriceRankingUpdate, Any, Any]:
    """Price ranking updates for the component exchanges used to calculate the Deribit index for the given `index_name`.
    ...
    References:
      - [Official docs](https://docs.deribit.com/subscriptions/market-data/deribit_price_rankingindex_name)
    """
    return self.subscribe(
      f'deribit_price_ranking.{index_name}',
      meta={'public': True},
      validate=validate,
      response_type=PriceRankingUpdate,
    )
