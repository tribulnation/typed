...
validate_trades_by_kind_currency = validator[list[TradesByKindCurrencyUpdate]](
  list[TradesByKindCurrencyUpdate]
)
...
class TradesByKindCurrency(StreamEndpoint):
  ...
  ) -> StreamManager[list[TradesByKindCurrencyUpdate], Any, Any]:
