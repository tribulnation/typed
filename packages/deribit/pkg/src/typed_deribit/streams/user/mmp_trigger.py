  ...
  **📖 Related Article:** [Market Maker Protection API Configuration](https://docs.deribit.com/articles/market-maker-protection)"""
  ...
  def mmp_trigger(
    ...
    **Allowed values:** `btc_usd`, `eth_usd`, `ada_usdc`, `algo_usdc`, `avax_usdc`, ... (total 47 values)
    ...
    References:
      - [Official docs](https://docs.deribit.com/api-reference/subscriptions/user-mmp_trigger-index_name)
    """
    return self.subscribe(
      f'user.mmp_trigger.{index_name}',
      meta={},
      validate=validate,
      response_type=MmpTriggerUpdate,
    )
