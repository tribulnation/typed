...
class Request(TypedDict):
  ...
  """Website of the beneficiary VASP. Required if the address book entry is associated with a VASP that is not on the venue's list of known VASPs."""
  beneficiary_first_name: NotRequired[str]
  ...
  extra_currencies: NotRequired[list[str]]
  """Currencies to add this address for, in addition to `currency`. Available only for ERC20 currencies -- without this, an ERC20 address is added for every ERC20-hosted asset."""
...
class AddToAddressBook(RpcEndpoint):
  ...
  async def add_to_address_book(
    ...
    *,
    ...
    References:
      - [Official docs](https://docs.deribit.com/api-reference/wallet/private-add_to_address_book)
    """
    ...
    if extra_currencies is not None:
      request['extra_currencies'] = extra_currencies
    return await self.request(
      ...
      response_type=AddressBookEntry,
    )
