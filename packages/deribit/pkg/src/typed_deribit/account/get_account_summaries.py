...
from typed_deribit.schemas import ChangeMarginModelApiLimit, TradingProductDetail
...
class Request(TypedDict):
  ...
  """Include additional account-identity fields."""
...
class GetAccountSummaries(RpcEndpoint):
  ...
  async def get_account_summaries(
    ...
    *,
    ...
    References:
      - [Official docs](https://docs.deribit.com/api-reference/account-management/private-get_account_summaries)
    """
    ...
    return await self.request(
      ...
      response_type=AccountSummaries,
    )
