...
class VerifyAptosChallenge(AuthEndpoint):
  ...
  async def verify_aptos_challenge(
    ...
    *,
    ...
    Args:
      ...
      signature: EIP-191 compliant signature signed by the Aptos account address requesting authentication.
      validate: Override this call's response validation; falls back to the client-level default when omitted.

    References:
      - [Official docs](https://docs.moralis.com/api-reference/challenge/verify-aptos-challenge)
    """
    return await self.request(
      ...
      response_type=VerifyAptosChallengeResponse,
    )
