...
class VerifyEvmChallenge(AuthEndpoint):
  ...
  async def verify_evm_challenge(
    ...
    *,
    ...
    References:
      - [Official docs](https://docs.moralis.com/api-reference/challenge/verify-evm-challenge)
    """
    return await self.request(
      ...
      response_type=VerifyEvmChallengeResponse,
    )
