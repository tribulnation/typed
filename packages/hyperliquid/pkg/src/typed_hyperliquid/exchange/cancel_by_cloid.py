...
class CancelByCloidOk(TypedDict):
  """The venue accepted the action as a whole; check each entry of `response.data.statuses` for per-cancel outcomes, which may still carry an individual `error`."""

  status: Literal['ok']
  """The venue accepted the action as a whole."""
  response: CancelByCloidActionResult


CancelByCloidResponse = CancelByCloidOk | ExchangeError
