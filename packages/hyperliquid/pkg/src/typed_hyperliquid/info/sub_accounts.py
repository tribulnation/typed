...
class PerpPosition(TypedDict):
  ...
  liquidationPx: Decimal | None
  """Estimated liquidation price for the position, or `null` when the venue reports no liquidation price for it. Confirmed live on mainnet; the rule the venue applies is undocumented."""
  marginUsed: Decimal
