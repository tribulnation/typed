...
class Request(TypedDict):
  ...
  """Address to evaluate follower-specific fields (e.g. `maxWithdrawable`) for, in 42-character hexadecimal format."""
  vaultAddress: str
  """Address of the vault to query, in 42-character hexadecimal format."""
...
class VaultFollower(TypedDict):
  ...
  vaultEntryTime: TimestampMillis
...
Response = VaultDetails | None


class VaultDetailsEndpoint(InfoCore):
  ...
  async def vault_details(
    ...
    *,
    ...
    """
    request: Request = Request(vaultAddress=vault_address)
    if user is not None:
      request['user'] = user
