...
class UserNonFundingLedgerUpdatesAction(TypedDict):
...
adapter = pydantic.TypeAdapter(list[UserNonFundingLedgerEntry])
...
class UserNonFundingLedgerUpdates(InfoMixin):
  async def user_non_funding_ledger_updates(
    ...
    *,
  ...
  ) -> list[UserNonFundingLedgerEntry]:
    ...
    """
    params: UserNonFundingLedgerUpdatesAction = {
  ...
  async def user_non_funding_ledger_updates_paged(
    ...
    *,
  ...
  ) -> AsyncIterator[list[UserNonFundingLedgerEntry]]:
    """Yield successive pages of `user_non_funding_ledger_updates`.
    ...
    overlap: list[UserNonFundingLedgerEntry] = []
    pages = 0
    while True:
