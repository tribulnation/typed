...
class GetNftsForContract(ChainNft):
  ...
  def get_nfts_for_contract_paged(
    ...
    *,
    ...
    Paged variant of `get_nfts_for_contract`: Passes each page's token back as `startToken` and stops when a response carries no `pageKey`. Awaitable (flattens every page) or async-iterable (one page at a time).
    ...
    References:
      - [Official docs](https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-metadata-endpoints/get-nf-ts-for-contract-v-3)
    """

    async def next(start_token: str) -> tuple[Sequence[dict[str, Any]], str | None]:
  ...
  async def get_nfts_for_contract(
    ...
    *,
    ...
    return await self.request(
      request,
      method='GET',
      path='/getNFTsForContract',
      validate=validate,
      request_type=Request,
      response_type=NftsForContractResponse,
    )
