...
class GetNftsForCollection(ChainNft):
  ...
  def get_nfts_for_collection_paged(
    ...
    *,
    ...
    Paged variant of `get_nfts_for_collection`: Passes each page's token back as `startToken` and stops when a response carries no `pageKey`. Awaitable (flattens every page) or async-iterable (one page at a time).
