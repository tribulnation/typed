...
|---|---|---|
| `KRAKEN_API_KEY` | private REST calls, `streams.private`, `streams.trading` | Kraken API key. |
| `KRAKEN_PRIVATE_KEY` | private REST calls, `streams.private`, `streams.trading` | Kraken private key, used to sign requests. |
