"""`spot.account.api_key_info` -- private Spot endpoint."""
...
validate_api_key_info = validator(ApiKeyInfo)


class ApiKeyInfoEndpoint(RpcEndpoint):
  """`spot.account.api_key_info`."""

  async def api_key_info(self, otp: str | None = None) -> ApiKeyInfo:
    ...
    **API Key Permissions Required:** `None`
    ...
    return await self.authed_request(
      '/0/private/GetApiKeyInfo', data, validator=validate_api_key_info
    )
