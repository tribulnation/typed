...
connection shared between the `private` channels and `trading` methods -- Kraken
serves both over the same authenticated socket.
"""
...
class Streams:
  ...
  def trading(self) -> Trading:
    return Trading(client=self.private_client)
