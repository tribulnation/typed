...
from typed_kraken.core import TimestampNanos, timestamp_nanos
  ...
  async def trades(
    ...
    *,
    ...
    if since is not None:
      params['since'] = timestamp_nanos.dump(since)
    ...
    return await self.request(
      '/0/public/Trades', params, validator=validate_trades, validate=validate
    )
