...
The product catalog under `app.advanced_trade.http.products.public`, and the `app.advanced_trade.streams.market_data` WebSocket channels, need no key at all. Skip credential resolution entirely with `public=True`:
