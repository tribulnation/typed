...
class AmountMaximumTotal(TypedDict):
  """Maximum USD paid after slippage; populated for BUY orders sized in base."""
...
class AmountMinimumTotal(TypedDict):
  """Minimum USD received after slippage; populated for SELL orders sized in base."""
...
class AmountRemainingLimits(TypedDict):
  """The account's remaining compliance purchase limit."""
...
class AmountTotalLimit(TypedDict):
  """The account's total compliance purchase limit."""
...
class ComplianceLimitData(TypedDict):
  total_limit: NotRequired[AmountTotalLimit]
  remaining_limits: NotRequired[AmountRemainingLimits]
...
class PredictionOrderMetadata(TypedDict):
  ...
  minimum_total: NotRequired[AmountMinimumTotal]
  maximum_total: NotRequired[AmountMaximumTotal]
