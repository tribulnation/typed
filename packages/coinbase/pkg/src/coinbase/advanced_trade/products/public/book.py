...
class Book(RpcEndpoint):
  ...
  async def book(
    ...
    *,
    ...
    """No authentication required. Get an order book snapshot for one product.
    ...
    References:
      - [Official docs](https://docs.cdp.coinbase.com/api-reference/advanced-trade-api/rest-api/public/get-public-product-book)
    """
    params: dict = {
