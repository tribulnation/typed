...
class AccountV2(TypedDict):
  ...
  type: str
  """Account type. Observed example values include `wallet` and `vault`; the docs page fetched for this spec did not enumerate the closed set, so this is left untyped rather than guessed."""
  ...
  async def __call__(
    ...
    *,
    ...
    return await self.authed_request(
      'GET', '/v2/accounts', params=params, validator=validator(AccountsPage)
    )
