...
from typed_coinbase.schemas import FutureProductDetails
...
class Request(TypedDict):
  ...
  """Only returns products matching this contract expiry type. Futures products only."""
  ...
  """Return all products across all product types."""
  ...
  """Sort order for the returned products."""
  ...
  """Filter futures products by underlying type."""
  user_country_code: NotRequired[str]
  """The requesting user's country code, for country-specific display filtering."""
  expired: NotRequired[bool]
  """Return recently expired instruments instead of active ones."""
...
class PublicProduct(TypedDict):
  ...
  """Current price, as a decimal string. Empty string confirmed live on some futures/perps and a minority of spot products."""
  price_percentage_change_24h: Decimal | Literal['']
  """24h price change, as a percentage string. Empty string confirmed live on some futures/perps and a minority of spot products."""
  volume_24h: Decimal | Literal['']
  """24h trading volume, as a decimal string. Empty string confirmed live on some futures/perps and a minority of spot products."""
  volume_percentage_change_24h: Decimal | Literal['']
  """24h volume change, as a percentage string. Empty string confirmed live on some futures/perps and a minority of spot products."""
  base_increment: Decimal
  """Smallest allowed increment of the base currency."""
  quote_increment: Decimal
  """Smallest allowed increment of the quote currency."""
  quote_min_size: NotRequired[Decimal]
  """Minimum order size, quoted in the quote currency."""
  quote_max_size: NotRequired[Decimal]
  """Maximum order size, quoted in the quote currency."""
  base_min_size: NotRequired[Decimal]
  """Minimum order size, quoted in the base currency."""
  base_max_size: NotRequired[Decimal]
  ...
  approximate_quote_24h_volume: Decimal | Literal['']
  """Approximate 24h volume, quoted in the quote currency. Empty string confirmed live on some futures/perps and a minority of spot products."""
  new_at: TimestampIso | None
  """Listing time, ISO 8601; `null` confirmed live on a product with no 'new' tag (the key itself is always present)."""
  ...
  async def list(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=PublicProductsPage,
    )
