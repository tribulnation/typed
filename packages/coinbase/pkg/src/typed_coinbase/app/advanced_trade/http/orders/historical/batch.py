...
class Batch(RpcEndpoint):
  ...
  def batch_paged(
    ...
    *,
    ...
    Paged variant of `batch`: Passes each page's token back as `cursor` and stops when a response carries no `cursor`. Awaitable (flattens every page) or async-iterable (one page at a time).
