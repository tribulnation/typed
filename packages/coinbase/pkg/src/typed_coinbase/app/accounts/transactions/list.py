...
class Request(TypedDict):
  ...
  """Page size, 0-100. Defaults to 25."""
  starting_after: NotRequired[str]
  """Cursor from a previous page's `pagination.next_starting_after`; fetches the page after this transaction id."""
  ending_before: NotRequired[str]
  """Cursor from a previous page's response; fetches the page before this transaction id."""
...
class Transaction(TypedDict):
  ...
  network: NotRequired[TransactionNetworkNetwork]
  to: NotRequired[
...
class List(RpcEndpoint):
  ...
  def list_paged(
    ...
    *,
    ...
    async def next(starting_after: str) -> tuple[Sequence[Transaction], str | None]:
  ...
  async def list(
    ...
    *,
    ...
    return await self.request(
      ...
      response_type=TransactionsPage,
    )
