...
class Deposit(TypedDict):
  ...
  """The payment method (e.g. a bank) this deposit was made from."""
  transaction: TransactionReference
  """The account transaction associated with this deposit, once committed."""
  amount: Money
  """Deposit amount."""
  subtotal: Money
  """Amount without fees."""
  fee: Money
  """Fees charged for this deposit."""
