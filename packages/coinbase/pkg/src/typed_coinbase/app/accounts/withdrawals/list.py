...
class Withdrawal(TypedDict):
  ...
  """The payment method (e.g. a bank) this withdrawal was made to."""
  transaction: TransactionReference
  """The account transaction associated with this withdrawal, once committed."""
  amount: Money
  """Withdrawal amount."""
  subtotal: Money
  """Amount without fees."""
  fee: Money
  """Fees charged for this withdrawal."""
