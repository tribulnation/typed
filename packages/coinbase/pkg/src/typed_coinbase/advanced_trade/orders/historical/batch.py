...
class Batch(RpcEndpoint):
  ...
  async def batch(
    ...
    *,
    ...
    if start_date is not None:
      params['start_date'] = timestamp_iso.dump(start_date)
    if end_date is not None:
      params['end_date'] = timestamp_iso.dump(end_date)
  ...
  def batch_paged(
    ...
    *,
    ...
    """Page through `batch`, awaitable (flattens every page) or async-iterable
    (one page at a time).
    """
