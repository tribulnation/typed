...
class CoinbaseBase:
  ...
  international_client: HttpRpcClient = field(default_factory=international_http)
  """Credential-free International Exchange public market data."""
  ...
  async def __aenter__(self) -> Self:
    await asyncio.gather(
      ...
      self.international_client.__aenter__(),
    )
    return self
  ...
  async def __aexit__(self, exc_type, exc_value, traceback):
    await asyncio.gather(
      ...
      self.international_client.__aexit__(exc_type, exc_value, traceback),
    )
